  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className={`fixed inset-y-0 left-0 w-72 bg-white dark:bg-gray-800 shadow-2xl z-50 transform transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${
        ...
        <div className="relative h-20 bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-between px-6 overflow-hidden">
          ...
          {menuItems.map((item) => {
            ...
            return (
              <React.Fragment key={item.path}>
                ...
                >
                  <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 rounded-r bg-gradient-to-b from-blue-400 to-blue-500 transition-all duration-300 ${isActive ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`} />
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-700 opacity-0 group-hover:opacity-10 transition-opacity rounded-xl" />
                </Link>
              </React.Fragment>
            );
          })}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100 dark:border-gray-700">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900/20 hover:text-gray-700 dark:hover:text-gray-400 transition-all duration-300 group"
          >
        ...
        <div className="hidden lg:flex items-center justify-between px-6 py-4 bg-white/50 dark:bg-gray-800/50 backdrop-blur-xl border-b border-gray-100 dark:border-gray-700 sticky top-0 z-30">
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-2 w-64 rounded-xl bg-gray-100 dark:bg-gray-700 border-0 focus:ring-2 focus:ring-blue-500 text-sm transition-all"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button className="relative p-2.5 rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all hover:scale-105 active:scale-95">
              <Bell size={20} />
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-gray-700 rounded-full animate-pulse" />
            </button>
            ...
            <div className="flex items-center gap-3 pl-3 border-l border-gray-200 dark:border-gray-600">
              ...
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold shadow-lg shadow-blue-500/30">
                A
              </div>
            </div>
          </div>
